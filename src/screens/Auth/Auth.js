...
import backgroundImage from '../../assets/mnbackground.jpg';
...
class AuthScreen extends Component {
    state = {
        ...
        authMode: "login",
        // Inputien hallinta ja validointi
        controls: {
            email: {
                value: "",
                valid: false,
    ...
    constructor (props) {
        super(props);
        // Tarkistetaan miten päin laite on ja asetetaan tyylejä sen mukaan
        Dimensions.addEventListener("change", this.updateStyles);
    }

    // Poistetaan EventListener ettei tule memory leakia
    ...
    render() {
        ...
        // Näytetään otsikkoteksti vain jos laite on pystyasennossa
        if (this.state.viewMode === "portrait") {
            headingText = (
                <MainText>
                    <HeadingText>{`Welcome to Travellr!\n Please Log In`}</HeadingText>
                </MainText>
            );
        }
        // Näytetään salasanan vahvistus vain signupissa
                    ...
                    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                        <View style={styles.inputContainer}>
                            <DefaultInput 
                                ...
                                // Määritetään millainen näppäimistö aukeaa kenttää painaessa
                                autoCapitalize="none"
                                autoCorrect={false}
